...
public:
	...
	enum class Mouse {
		...
		MOUSE_X1 = SDL_BUTTON(SDL_BUTTON_X1),
		MOUSE_X2 = SDL_BUTTON(SDL_BUTTON_X2)
	};
	 ...
	 * @return false if no
	 */
	NODISCARD static const bool check_key_down(Keyboard event);
	/**
	 ...
	 * @return false if no
	 */
	NODISCARD static const bool check_key_up(Keyboard event);
	 ...
	 * @return const bool
	 */
	NODISCARD static const bool check_mouse_button(Mouse mouse);
	/**
...
private:
	...
	static uint8* m_prevKeyboardState;
